...
<head>
  ...
  <!-- Sertakan file CSS FullCalendar -->
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="list-group-item">
                                      <div class ="d-flex w-100 justify-content-between">
                                        <div class ="font-weight-bold">Senin</div>
                                        <div class ="font-weight-bold">13.00-15.00</div>
                                      </div>
                                      <div class ="d-flex w-100 justify-content-between">
                                        <div class ="">Basis Data</div>
                                        <div class ="">TI 3A</div>
                                      </div>
                                      <br>
                                      <div class ="d-flex w-100 justify-content-between">
                                        <div class ="font-weight-bold">Selasa</div>
                                        <div class ="font-weight-bold">13.00-15.00</div>
                                      </div>
                                      <div class ="d-flex w-100 justify-content-between">
                                        <div class ="">Basis Data</div>
                                      ...
                                      <br>
                                      <div class ="d-flex w-100 justify-content-between">
                                        <div class ="font-weight-bold">Rabu</div>
                                        <div class ="font-weight-bold">13.00-15.00</div>
                                      </div>
                                      <div class ="d-flex w-100 justify-content-between">
                                        <div class ="">Basis Data</div>
